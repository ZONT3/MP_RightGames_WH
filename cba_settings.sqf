...
force CBRN_factionMask_1715_ENG = "";
force CBRN_factionMask_1715_FRN = "";
force CBRN_factionMask_1715_KGB = "";
force CBRN_factionMask_1715_KOF = "";
force CBRN_factionMask_1715_KOS = "";
force CBRN_factionMask_1715_ROP = "";
force CBRN_factionMask_1715_SPN = "";
force CBRN_factionMask_armst_mut_new = "";
force CBRN_factionMask_blot_austria = "";
force CBRN_factionMask_blot_civilian = "";
force CBRN_factionMask_blot_france = "";
force CBRN_factionMask_blot_germany = "";
force CBRN_factionMask_blot_italy = "";
force CBRN_factionMask_blot_ottoman = "";
force CBRN_factionMask_blot_russia = "";
force CBRN_factionMask_blot_uk = "";
...
force CBRN_factionMask_Cannibal_Units_f = "";
force CBRN_factionMask_ChaosReinforcments = "";
force CBRN_factionMask_CIV_F = "";
force CBRN_factionMask_CIV_IDAP_F = "";
force CBRN_factionMask_Colonist = "";
force CBRN_factionMask_Dinos = "";
force CBRN_factionMask_Dinos_E = "";
force CBRN_factionMask_Dinos_W = "";
...
force CBRN_factionMask_Feud_Enemy_Casey = "";
force CBRN_factionMask_Feud_Vehicles_Casey = "";
force CBRN_factionMask_Fued_Guard_Casey = "";
force CBRN_factionMask_Fued_Guard_Dos = "";
force CBRN_factionMask_GreatBritain = "";
...
force CBRN_factionMask_JMSL_barbar_faction = "";
force CBRN_factionMask_JMSL_celtic_faction = "";
force CBRN_factionMask_JMSL_roman_faction = "";
force CBRN_factionMask_LIB_ACI = "";
force CBRN_factionMask_LIB_ARR = "";
force CBRN_factionMask_LIB_CIV = "";
force CBRN_factionMask_LIB_DAK = "";
force CBRN_factionMask_LIB_FFI = "";
force CBRN_factionMask_LIB_FSJ = "";
force CBRN_factionMask_LIB_GUER = "";
force CBRN_factionMask_LIB_LUFTWAFFE = "";
force CBRN_factionMask_LIB_LUFTWAFFE_w = "";
force CBRN_factionMask_LIB_MKHL = "";
force CBRN_factionMask_LIB_NAC = "";
force CBRN_factionMask_LIB_NKVD = "";
force CBRN_factionMask_LIB_PANZERWAFFE = "";
force CBRN_factionMask_LIB_PANZERWAFFE_w = "";
force CBRN_factionMask_LIB_RAAF = "";
force CBRN_factionMask_LIB_RAF = "";
force CBRN_factionMask_LIB_RBAF = "";
force CBRN_factionMask_LIB_RKKA = "";
force CBRN_factionMask_LIB_RKKA_w = "";
force CBRN_factionMask_LIB_SD_ATTACKERS = "";
force CBRN_factionMask_LIB_SD_DEFENDERS = "";
force CBRN_factionMask_LIB_SD_SystemUnits = "";
force CBRN_factionMask_LIB_UK_AB = "";
force CBRN_factionMask_LIB_UK_AB_w = "";
force CBRN_factionMask_LIB_UK_ARMY = "";
force CBRN_factionMask_LIB_UK_ARMY_w = "";
force CBRN_factionMask_LIB_UK_DR = "";
force CBRN_factionMask_LIB_US_101AB = "";
force CBRN_factionMask_LIB_US_82AB = "";
force CBRN_factionMask_LIB_US_AIRFORCE = "";
force CBRN_factionMask_LIB_US_AIRFORCE_w = "";
force CBRN_factionMask_LIB_US_ARMY = "";
force CBRN_factionMask_LIB_US_ARMY_w = "";
force CBRN_factionMask_LIB_US_RANGERS = "";
force CBRN_factionMask_LIB_US_TANK_TROOPS = "";
force CBRN_factionMask_LIB_US_TANK_TROOPS_w = "";
force CBRN_factionMask_LIB_USSR_AIRFORCE = "";
force CBRN_factionMask_LIB_USSR_AIRFORCE_w = "";
force CBRN_factionMask_LIB_USSR_TANK_TROOPS = "";
force CBRN_factionMask_LIB_USSR_TANK_TROOPS_w = "";
force CBRN_factionMask_LIB_WEHRMACHT = "";
force CBRN_factionMask_LIB_WEHRMACHT_w = "";
...
force CBRN_factionMask_SG_STURM = "";
force CBRN_factionMask_SG_STURM_w = "";
force CBRN_factionMask_SG_STURMPANZER = "";
...
force CBRN_factionMask_UnitedStates = "";
...
force CBRN_factionMask_WBK_Warhammer_Horses = "";
force CBRN_factionMask_WBK_Warhammer_IM_B = "";
...
CBRN_factionMask_Cad667 = "";
CBRN_factionMask_Cad667_Indep = "";
CBRN_factionMask_Cad667_Op = "";
CBRN_factionMask_Cad700 = "";
CBRN_factionMask_Cad700_Indep = "";
CBRN_factionMask_Cad700_Op = "";
CBRN_factionMask_Cad776 = "";
CBRN_factionMask_Cad776_Indep = "";
CBRN_factionMask_Cad776_Op = "";
CBRN_factionMask_Cad836 = "";
CBRN_factionMask_Cad836_Indep = "";
CBRN_factionMask_Cad836_Op = "";
CBRN_factionMask_ChaosReinforcments = "";
CBRN_factionMask_CIV_F = "";
CBRN_factionMask_CIV_IDAP_F = "";
CBRN_factionMask_dev_mutants = "";
CBRN_factionMask_DKoK_1489th = "";
CBRN_factionMask_DKoK_1489th_Indep = "";
CBRN_factionMask_DKoK_1489th_OP = "";
CBRN_factionMask_DKoK_1490th = "";
CBRN_factionMask_DKoK_1490th_Indep = "";
CBRN_factionMask_DKoK_1490th_OP = "";
CBRN_factionMask_DKoK_1491st = "";
CBRN_factionMask_DKoK_1491st_Indep = "";
CBRN_factionMask_DKoK_1491st_OP = "";
CBRN_factionMask_DKoK_82nd = "";
CBRN_factionMask_DKoK_82nd_Indep = "";
CBRN_factionMask_DKoK_82nd_OP = "";
CBRN_factionMask_Dos_P_Drop_Pods = "";
CBRN_factionMask_DOS_SM = "";
CBRN_factionMask_DSA_DeltaX = "";
CBRN_factionMask_DSA_Spooks = "";
CBRN_factionMask_DT_ChaosDreads = "";
CBRN_factionMask_Elysian_13 = "";
CBRN_factionMask_Elysian_13_Indep = "";
CBRN_factionMask_Elysian_13_OP = "";
CBRN_factionMask_Elysian_181 = "";
CBRN_factionMask_Elysian_181_Indep = "";
CBRN_factionMask_Elysian_181_OP = "";
CBRN_factionMask_Elysian_56 = "";
CBRN_factionMask_Elysian_56_Indep = "";
CBRN_factionMask_Elysian_56_OP = "";
CBRN_factionMask_Elysian_99 = "";
CBRN_factionMask_Elysian_99_Indep = "";
CBRN_factionMask_Elysian_99_OP = "";
CBRN_factionMask_GSC_TIOW = "";
CBRN_factionMask_IC_CAD_BLU_desert = "";
CBRN_factionMask_IC_CAD_BLU_forest = "";
CBRN_factionMask_IC_CAD_BLU_snow = "";
CBRN_factionMask_IC_PILOT_BLU = "";
CBRN_factionMask_IC_SCION_BLU = "";
CBRN_factionMask_IC_SL_B = "";
CBRN_factionMask_IC_SOS = "";
CBRN_factionMask_Imperial_Navy_B = "";
CBRN_factionMask_Imperial_Navy_I = "";
CBRN_factionMask_Imperial_Navy_O = "";
...
CBRN_factionMask_Mars_XIII = "";
CBRN_factionMask_MechanicusVehicles = "";
CBRN_factionMask_ML700_Bloodpact = "";
CBRN_factionMask_ML700_ImperialGuard = "";
CBRN_factionMask_ML700_SistersOfBattle = "";
...
CBRN_factionMask_OPTRE_CAA = "";
CBRN_factionMask_OPTRE_Ins = "";
CBRN_factionMask_OPTRE_PD = "";
CBRN_factionMask_OPTRE_UEG_Civ = "";
CBRN_factionMask_OPTRE_UNSC = "";
CBRN_factionMask_Orks = "";
CBRN_factionMask_Orks_BLU = "";
CBRN_factionMask_Orks_OP = "";
CBRN_factionMask_Reinforcments = "";
CBRN_factionMask_Tau_B = "";
CBRN_factionMask_Tau_I = "";
CBRN_factionMask_Tau_O = "";
CBRN_factionMask_TIOW_Chaos_HQ_B = "";
CBRN_factionMask_TIOW_Chaos_HQ_I = "";
CBRN_factionMask_TIOW_Chaos_HQ_O = "";
CBRN_factionMask_TIOW_ChaosSpaceMarines = "";
CBRN_factionMask_TIOW_Drop_Pods = "";
CBRN_factionMask_TIOW_IG_HQ_B = "";
CBRN_factionMask_TIOW_IG_HQ_I = "";
CBRN_factionMask_TIOW_IG_HQ_O = "";
CBRN_factionMask_TIOW_IQF = "";
CBRN_factionMask_TIOW_Mordian_Blu = "";
CBRN_factionMask_TIOW_Mordian_Indep = "";
CBRN_factionMask_TIOW_Mordian_OP = "";
CBRN_factionMask_TIOW_Necrons_0 = "";
CBRN_factionMask_TIOW_Necrons_1 = "";
CBRN_factionMask_TIOW_Necrons_2 = "";
CBRN_factionMask_TIOW_OCC_PDF_0 = "";
CBRN_factionMask_TIOW_OCC_PDF_1 = "";
CBRN_factionMask_TIOW_OCC_PDF_2 = "";
CBRN_factionMask_TIOW_Ren_B_B = "";
CBRN_factionMask_TIOW_Ren_B_I = "";
CBRN_factionMask_TIOW_Ren_B_O = "";
CBRN_factionMask_TIOW_Ren_BL_B = "";
CBRN_factionMask_TIOW_Ren_BL_I = "";
CBRN_factionMask_TIOW_Ren_BL_O = "";
CBRN_factionMask_TIOW_Ren_G_B = "";
CBRN_factionMask_TIOW_Ren_G_I = "";
CBRN_factionMask_TIOW_Ren_G_O = "";
CBRN_factionMask_TIOW_Ren_GR_B = "";
CBRN_factionMask_TIOW_Ren_GR_I = "";
CBRN_factionMask_TIOW_Ren_GR_O = "";
CBRN_factionMask_TIOW_SpaceMarines = "";
CBRN_factionMask_TIOW_Val_Blu = "";
CBRN_factionMask_TIOW_Val_Indep = "";
CBRN_factionMask_TIOW_Val_OP = "";
CBRN_factionMask_Virtual_F = "";
CBRN_factionMask_VNG_34th_Vanguard = "";
CBRN_factionMask_VNG_34thVanguard = "";
CBRN_factionMask_WBK_AI = "";
CBRN_factionMask_WBK_AI_Melee = "";
CBRN_factionMask_WBK_AI_ZHAMBIES = "";
CBRN_factionMask_WBK_Warhammer = "";
CBRN_factionMask_WBK_Warhammer_AS = "";
