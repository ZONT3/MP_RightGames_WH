...
force ace_medical_blood_bloodLifetime = 1;
...
force ace_medical_gui_maxDistance = 5.99389;
...
force ace_medical_playerDamageThreshold = 15.3662;
force ace_medical_spontaneousWakeUpChance = 0.301221;
force ace_medical_spontaneousWakeUpEpinephrineBoost = 15.4761;
...
force ace_medical_treatment_litterCleanupDelay = 311.458;
...
force ace_advanced_fatigue_performanceFactor = 5.0;
force ace_advanced_fatigue_recoveryFactor = 5.0;
...
force ace_pylons_searchDistance = 29.7934;
...
Achilles_var_blot_austria = true;
Achilles_var_blot_civilian = true;
Achilles_var_blot_france = true;
Achilles_var_blot_germany = true;
Achilles_var_blot_italy = true;
Achilles_var_blot_ottoman = true;
Achilles_var_blot_russia = true;
Achilles_var_blot_uk = true;
...
Achilles_var_Cannibal_Units_f = true;
Achilles_var_ChaosReinforcments = true;
Achilles_var_CIV_F = true;
Achilles_var_CIV_IDAP_F = true;
Achilles_var_Colonist = true;
Achilles_var_Dinos = true;
Achilles_var_Dinos_E = true;
Achilles_var_Dinos_W = true;
...
Achilles_var_Dos_P_Drop_Pods = true;
Achilles_var_DOS_SM = true;
...
Achilles_var_Feud_Enemy_Casey = true;
Achilles_var_Feud_Vehicles_Casey = true;
Achilles_var_Fued_Guard_Casey = true;
Achilles_var_Fued_Guard_Dos = true;
Achilles_var_GreatBritain = true;
...
Achilles_var_JMSL_barbar_faction = true;
Achilles_var_JMSL_celtic_faction = true;
Achilles_var_JMSL_roman_faction = true;
...
Achilles_var_UnitedStates = true;
...
force CBRN_factionMask_AM_mars = "FS_ICP_Scion_mask_01";
force CBRN_factionMask_BLU_CTRG_F = "";
force CBRN_factionMask_BLU_F = "FS_ICP_SL_Gasmask_2";
...
force CBRN_factionMask_ChaosReinforcments = "FS_ICP_SL_Gasmask_2";
...
force CBRN_factionMask_Dos_P_Drop_Pods = "";
force CBRN_factionMask_DOS_SM = "";
force CBRN_factionMask_DSA_DeltaX = "";
force CBRN_factionMask_DSA_Spooks = "";
force CBRN_factionMask_DT_ChaosDreads = "";
...
force CBRN_factionMask_GSC_TIOW = "";
force CBRN_factionMask_IC_CAD_BLU_desert = "FS_ICP_Reabreather_grey";
force CBRN_factionMask_IC_CAD_BLU_forest = "FS_ICP_Reabreather_green";
force CBRN_factionMask_IC_CAD_BLU_snow = "FS_ICP_Reabreather_white";
force CBRN_factionMask_IC_PILOT_BLU = "FS_ICP_Pilot_mask";
force CBRN_factionMask_IC_SCION_BLU = "FS_ICP_Scion_mask_01";
force CBRN_factionMask_IC_SL_B = "FS_ICP_SL_Gasmask";
...
force CBRN_factionMask_IND_F = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_IND_G_F = "";
force CBRN_factionMask_IND_L_F = "";
force CBRN_factionMask_Interactive_F = "";
force CBRN_factionMask_Mars_XIII = "";
force CBRN_factionMask_MechanicusVehicles = "";
force CBRN_factionMask_ML700_Bloodpact = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_ML700_ImperialGuard = "";
force CBRN_factionMask_ML700_SistersOfBattle = "";
force CBRN_factionMask_OPF_F = "FS_ICP_SL_Gasmask_2";
...
force CBRN_factionMask_Reinforcments = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_Tau_B = "";
force CBRN_factionMask_Tau_I = "";
force CBRN_factionMask_Tau_O = "";
force CBRN_factionMask_TIOW_Chaos_HQ_B = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Chaos_HQ_I = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Chaos_HQ_O = "FS_ICP_SL_Gasmask_2";
...
force CBRN_factionMask_TIOW_Ren_B_B = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_B_I = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_B_O = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_BL_B = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_BL_I = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_BL_O = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_G_B = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_G_I = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_G_O = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_GR_B = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_GR_I = "FS_ICP_SL_Gasmask_2";
force CBRN_factionMask_TIOW_Ren_GR_O = "FS_ICP_SL_Gasmask_2";
...
force CBRN_factionMask_VNG_34th_Vanguard = "";
force CBRN_factionMask_VNG_34thVanguard = "";
force CBRN_factionMask_WBK_AI = "";
force CBRN_factionMask_WBK_AI_Melee = "";
force CBRN_factionMask_WBK_AI_ZHAMBIES = "";
force CBRN_factionMask_WBK_Warhammer = "";
force CBRN_factionMask_WBK_Warhammer_AS = "";
force CBRN_factionMask_WBK_Warhammer_CH = "";
...
// Nassau 1715 (Melee)
H2H_Setting_Bayo_Damage = 1;

// Nassau 1715 (Melee) [ACE Settings]
H2H_Setting_ACE = false;
H2H_Setting_ACE_Bayo_ACE_Knockout = true;
H2H_Setting_ACE_Bayo_ACE_KnockoutDuration = 1;
H2H_Setting_Bayo_ACE_Damage = 0.7;
...
zen_faction_filter_0_1715_ENG = true;
zen_faction_filter_0_1715_KGB = true;
...
zen_faction_filter_0_blot_austria = true;
zen_faction_filter_0_blot_germany = true;
zen_faction_filter_0_blot_ottoman = true;
...
zen_faction_filter_0_Fued_Guard_Dos = true;
zen_faction_filter_0_GreatBritain = true;
zen_faction_filter_0_GSC_TIOW = true;
...
zen_faction_filter_1_1715_KOF = true;
zen_faction_filter_1_1715_KOS = true;
...
zen_faction_filter_1_blot_france = true;
zen_faction_filter_1_blot_italy = true;
zen_faction_filter_1_blot_russia = true;
zen_faction_filter_1_blot_uk = true;
...
zen_faction_filter_1_Dinos_E = true;
...
zen_faction_filter_1_Dos_P_Drop_Pods = true;
zen_faction_filter_1_DOS_SM = true;
...
zen_faction_filter_1_TIOW_IQF = true;
...
zen_faction_filter_2_Dinos = true;
...
zen_faction_filter_3_1715_ENG = true;
zen_faction_filter_3_1715_FRN = true;
zen_faction_filter_3_1715_SPN = true;
zen_faction_filter_3_blot_civilian = true;
zen_faction_filter_3_CIV_F = true;
zen_faction_filter_3_CIV_IDAP_F = true;
zen_faction_filter_3_Colonist = true;
