...
_x setskill 0.8;
	...
	[GF_Missions_allPlayers,["11_DAC_Search_Stolen","GF_Missions_Pack"],["Найдите украденный транспорт","Найдите украденный транспорт",""], _Group_Pos,true,1,true,"search",true] call BIS_fnc_taskCreate;
