...
((units _Vehicle_Patrol) select 0) moveInGunner _create_Land_Vehicle;
	...
	[GF_Missions_allPlayers,["15_Clear_Bunker_2","GF_Missions_Pack"],["Защищайте позицию","Защищайте Бункер",""], _Group_Pos,true,1,true,"defend",true] call BIS_fnc_taskCreate;
