...
GF Missions Script , configurable scripts.
...
For usage instructions and information of how to use the GF Missions Script please refer to the included documentation and/or example mission.
...
Forum topic:
- BI forums https://forums.bohemia.net/forums/topic/219080-gf-missions-script/
